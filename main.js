...
let proMap = {
    njuu: {
        down: "https://download.njuu.cf/",
        raw: "https://raw.njuu.cf/",
        home: "https://hub.njuu.cf/",
    },
    yzuu: {
        down: "https://download.yzuu.cf/",
        raw: "https://raw.yzuu.cf/",
        home: "https://hub.yzuu.cf/",
    },
    nuaa: {
        down: "https://download.nuaa.cf/",
        raw: "https://raw.nuaa.cf/",
        home: "https://hub.nuaa.cf/",
    },
    fastgit: {
...
let server = Object.keys(proMap).keys()[0] || "fastgit";
...
let include = [
    ...
    {
        match: (url) =>
            url.startsWith("https://raw.githubusercontent.com/") >= 0,
        to: (url) =>
            url.replace(
...
function apElectron() {
    ...
    this.regedit = function () {
        ...
        // debugger
        console.log(ap);
        window.require("electron").ipcRenderer.send = function (
            a,
            b,
            e,
            ...rest
